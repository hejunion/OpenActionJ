...
import com.ypg.merchant.services.concurrent.workmanager.AbstractManager;
 ...
 * 
 */
public final class NDEWorkManagerImpl extends AbstractManager implements WorkManager {
	 ...
	 */
	public NDEWorkManagerImpl(JDKThreadPool pool) {	
		super(pool);
	}
	 ...
	 */
	public NDEWorkManagerImpl(JDKThreadPool pool, int maxDaemons) {	
		this(pool);
	...
	public WorkItem schedule(Work work, WorkListener wl) throws WorkException,
		...
		NDEWorkItemImpl workItem = null;
		if (work instanceof Serializable) {
			workItem = new NDERemoteWorkItemImpl(work, wl, this);
		}
		else { 
			workItem = new NDEWorkItemImpl(work, wl);
		}
