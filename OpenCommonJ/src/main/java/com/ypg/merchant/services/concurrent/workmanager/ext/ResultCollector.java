...
import com.ypg.merchant.services.concurrent.workmanager.impl.nde.NDEWorkItemImpl;
...
public final class ResultCollector {
	...
	public void addWorkItem(WorkItem workItem) {
		...
		if (workItem instanceof NDEWorkItemImpl) {
			NDEWorkItemImpl fwi = (NDEWorkItemImpl) workItem;
